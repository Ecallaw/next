    ...
    <div className='py-2'>
      <div className='flex' onClick={opened ? close : open}>
        ...
        <div className='flex-1 flex items-center'>
          ...
          <div className='flex-col max-sm:hidden'>
      ...
      <Collapse in={opened}>
        <div className={"flex items-center pb-2 mr-4 mt-4 flex-1 text-gray-100 pb-2 border-b-2 border-gray-800 md:ml-24"}>
          <div className='flex-1'>Résultats</div>
          <Button  onClick={() => onDelete()} leftIcon={<MdRemoveCircle size="1rem" />} color="gray" className='bg-gray-700 m-0 h-8 mr-4 max-md:hidden'>Annuler</Button>
        ...
        {scores.map((entry: any, index: any) => {
          return (
            <div key={entry.id} className='flex mt-2 md:ml-24'>

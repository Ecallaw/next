...
export default function BottomNavigation() {
  ...
  return (
    <div className="fixed bottom-0 left-0 z-40 w-full h-auto bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
